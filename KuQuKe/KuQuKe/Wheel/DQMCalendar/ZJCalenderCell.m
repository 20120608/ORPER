...
- (instancetype)initWithFrame:(CGRect)frame{
    if (self = [super initWithFrame:frame]) {
        self.layer.borderColor = QMHexColor(@"e3e4e5").CGColor;
...
- (void)setupSubViews{
    ...
    CGFloat leftFlatBgW = self.contentView.frame.size.width / 2;
    ...
    CGFloat rightFlatBgW = self.contentView.frame.size.width / 2;
